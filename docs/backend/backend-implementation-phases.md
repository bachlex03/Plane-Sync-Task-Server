...
- [ ] [High] Hoàn thiện các domain cơ bản: Users ([Xem chi tiết](./Phase1/users.md)), Patients ([Xem chi tiết](./Phase1/patients.md)), Branches ([Xem chi tiết](./Phase1/branches.md)), Form Generator, File Upload ([Xem chi tiết](./Phase1/file-upload.md))
